            ...
            <div class="col-12 mt-4 mb-5">
                ...
                <div class="sotrundnichestvo">
                    <div class="sotrundnichestvo__text-block">
                        ...
                        <p>
                            У нас подобрана обширная база актуальных <a href="#" class="text--link-red">каталогов и образцов европейских производителей,</a> с которыми мы сотрудничаем.
                        </p>
                        <p>
                ...
                <div class="sotrundnichestvo__text-block--bottom">
                    <p>Отправляйте письма с предложениями к сотрудничеству на адрес: <a href="mailto:info@homeartidea.ru" class="text--link-red">info@homeartidea.ru</a> в произвольной форме. Мы обязательно свяжемся с вами и обсудим все детали и интересующие вас вопросы.</p>
                </div>
